...
enum TPP {TP1,TP2,TP3};
enum SLL {SL1,SL2};
enum Dir {LongOnly,ShortOnly,Both};
      ...
      if(SymbFlag || (LastType != Type1))  // It can be lightly accelerated by changing the sequence of checking the condition.
        {
         ...
         Res = (!FillingMode || (Type1 >= ORDER_FILLING_RETURN) || ((FillingMode & (Type1 + 1)) != Type1 + 1)) ?
               (((ExeMode == SYMBOL_TRADE_EXECUTION_EXCHANGE) || (ExeMode == SYMBOL_TRADE_EXECUTION_INSTANT)) ?
                ORDER_FILLING_RETURN : ((FillingMode == SYMBOL_FILLING_IOC) ? ORDER_FILLING_IOC : ORDER_FILLING_FOK)) :
               (ENUM_ORDER_TYPE_FILLING)Type1;
        }
